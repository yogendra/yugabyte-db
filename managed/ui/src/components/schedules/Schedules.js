...
const ScheduleDisplayItem = (
  ...
  const handleDeleteMenuItemClick = (scheduleUUID) => {
    handleDeleteAction(scheduleUUID);
  };

  const schedule = _.cloneDeep(rest.schedule);
          ...
          <div className="status-icon">
            ...
            >
              <MenuItem
                ...
                onClick={() => { handleDeleteMenuItemClick(schedule.scheduleUUID) }}
              >
...
export const Schedules = (
  {
    showAddCertificateModal, getSchedules, fetchUniverseList,
  ...
  const handleDeleteAction = (_scheduleUUID) => {
    showAddCertificateModal();
    setScheduleUUID(_scheduleUUID)
  };
        ...
        body={
          <Fragment>
            <YBModalForm
              ...
              cancelLabel={'Cancel'}
              onFormSubmit={handleDeleteSchedule}
            >
